...
class Cluster(object):
    ...
    def singleLinkageDist(self, other):
        ...
        for point in self.points:
            for others in other.points:
                dist.append(point.distance(others))
...
class ClusterSet(object):
    ...
    def mergeClusters(self, c1, c2):
        ...
        self.add(Cluster(c1.points + c2.points, c2.pointType))
    ...
    def findClosest(self, linkage):
        ...
        for e1, e2 in itertools.combinations(self.getClusters(), 2):
            if e1 != e2:
                dist = linkage(e1, e2)
    ...
    def mergeOne(self, linkage):
        ...
        setc1c2 = self.findClosest(linkage)
...
def buildCityPoints(fName, scaling):
    cityNames, featureList = readCityData(fName)
    points = []
...
#points = buildCityPoints(r'C:\Users\Laura\Dropbox\MIT\ProblemSet6\test.txt', False)
...
def test():
    #points = buildCityPoints(r'C:\Users\Laura\Dropbox\MIT\ProblemSet6\cityTemps.txt', False)
    #hCluster(points, Cluster.singleLinkageDist, 5, False)
    points = buildCityPoints(r'C:\Users\Laura\Dropbox\MIT\ProblemSet6\cityTemps.txt', True)
